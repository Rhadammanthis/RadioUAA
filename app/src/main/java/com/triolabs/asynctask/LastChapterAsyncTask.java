...
/**
* LastChapterAsyncTask realiza el request para traer todos los capitulos de kaltura
* @author Triolabs
* @Developer Raul Quintero Esparza
* @Designer Ivan Padilla
* @version 1.0
*/
public class LastChapterAsyncTask extends AsyncTask<String, Integer,String> {
	...
	public void setURL() {
		URL = Constant.HOST_KALTURA+"/api_v3/?service="+Constant.SERVICE_KALTURA_MEDIA+"&action="
					+Constant.ACTION_KALTURA_LIST+"&filter:orderBy=-createdAt&filter:orderBy&ks="+Constant.KS_KALTURA+"&format="+Constant.FORMAT_KALTURA;
	}
	...
	protected void onPostExecute(String result) {
		...
		if(result!=null){
			...
			LastChapterFragment.getInfoChapterLast(json);
			return;
		}
		LastChapterFragment.getInfoChapterLast(null);
